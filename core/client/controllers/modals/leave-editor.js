var LeaveEditorController = Ember.Controller.extend({
    ...
    actions: {
        confirmAccept: function () {
            ...
            if (!transition || !editorController) {
                this.notifications.showError('Lo sentimos, hubo un error en la aplicación. Por favor, notificale al equipo Ghost lo que pasó.');
    ...
    confirm: {
        accept: {
            text: 'Salir',
            buttonClass: 'btn btn-red btn-minor'
        },
        reject: {
            text: 'Cancelar',
